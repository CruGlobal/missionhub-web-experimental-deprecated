(function() {
  ...
  function config($mdThemingProvider, $mdIconProvider) {
    ...
    $mdThemingProvider.definePalette('cruGoldDarkContrast', {"50":"#fef8e9","100":"#fde9be","200":"#fcdb92","300":"#fbce6e","400":"#fac249","500":"#f9b625","600":"#da9f20","700":"#bb891c","800":"#9c7217","900":"#7d5b13","A100":"#fde9be","A200":"#fcdb92","A400":"#fac249","A700":"#bb891c"});
    var cruGoldLightContrast = $mdThemingProvider.extendPalette('cruGoldDarkContrast', {
      'contrastDefaultColor': 'light'
    });
    $mdThemingProvider.definePalette('cruGold', cruGoldLightContrast);
    ...
    $mdThemingProvider.theme('cruGoldDarkContrast')
      .primaryPalette('cruGoldDarkContrast')
      .accentPalette('cruDeepBlue');
    ...
    $mdIconProvider
      ...
      .icon('groupme', 'assets/icons/groupme.svg');
  }
